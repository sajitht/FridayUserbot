...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://tenor.com/GElC.gif"
else:
...
USER_BOT_WARN_ZERO = "`You were spamming my Boss's inbox, henceforth your have been blocked by my master's userbot.` "
USER_BOT_NO_WARN = ("`Hello My Friend !`"
                    "**Currently My Boss**\n"
                    "SAJITH is Busy ! Please Don't Spam My Masters Inbox\n\n"
